...
absl::Status ImageEmbedder::PostInit() { return absl::OkStatus(); }
...
absl::Status ImageEmbedder::Init(
  ...
  // Perform pre-initialization actions (by default, sets the process engine
  // for image pre-processing to kLibyuv as a sane default).
