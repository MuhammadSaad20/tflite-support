...
// Performs feature vector extraction on images.
//
...
//      feature vectors for this output layer.
...
class ImageEmbedder
 ...
 public:
  ...
  // Performs actual embedding extraction on the provided FrameBuffer.
  //
 ...
 protected:
  ...
  // Performs sanity checks on the provided ImageEmbedderOptions.
  static absl::Status SanityCheckOptions(const ImageEmbedderOptions& options);
